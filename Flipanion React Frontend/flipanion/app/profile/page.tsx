...
export default function ProfilePage() {
  ...
  React.useEffect(() => {
    ...
    if (username.length >= 3) {
      const timeoutId = setTimeout(async () => {
        ...
        // Check if username exists in custom User table (same as auth page)
        ...
        setUsernameAvailable(error?.code === 'PGRST116');
  ...
  const handleSaveUsername = async () => {
    ...
    // Validate username
    if (username.length < 3) {
      setMessage({ type: 'error', text: 'Benutzername muss mindestens 3 Zeichen lang sein.' });
      return;
    }
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center py-20">
            ...
            <p className="mt-6 text-lg text-gray-600 dark:text-gray-400">Profil wird geladen ...</p>
          </div>
        </main>
      </div>
    );
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Nicht angemeldet</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">Bitte melde dich an, um auf dein Profil zuzugreifen.</p>
            <Link 
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Benutzername</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400">So wirst du in der App angezeigt</p>
                </div>
              </div>
              {!editingUsername && (
                <button
            ...
            {editingUsername ? (
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    disabled={saving || (usernameAvailable === false) || username.length < 3 || username === originalUsername}
              ...
              <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                <p className="text-gray-900 dark:text-white font-medium">
                  {user.user_metadata?.name || <span className="text-gray-400 italic">Kein Benutzername</span>}
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">E-Mail-Adresse</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Deine Anmelde-E-Mail</p>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Benutzer-ID</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Deine eindeutige Kennung</p>
              </div>
            </div>
            <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              <p className="text-gray-600 dark:text-gray-400 font-mono text-sm break-all">{user.id}</p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 opacity-60">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Profilbild</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Dein personalisiertes Avatar</p>
                </div>
              </div>
