        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="pt-20 pb-16 text-center lg:pt-32">
            <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-white mb-6">
              Willkommen bei <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Flipanion</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              Dein Begleiter zum Lernen mit interaktiven Quizzen und Karteikarten
            </p>
          ...
          <div className="py-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Eigene Quizze erstellen</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Erstelle individuelle Quizze passend zu deinem Lernstil und teile sie mit anderen
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Interaktives Lernen</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Lerne mit dynamischen Karteikarten und Quizzen, die Spaß machen und wirken
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Fortschritt verfolgen</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Behalte deinen Lernfortschritt mit detaillierten Statistiken und Auswertungen im Blick
              </p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            Willkommen zurück, <span className="text-blue-600">{user?.user_metadata?.name || 'Nutzer'}</span>!
          </h2>
          <p className="text-gray-600 dark:text-gray-400">Bereit, deine Lernreise fortzusetzen?</p>
        </div>

        {/* Get Started Box */}
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-8 mb-8 text-white shadow-lg">
          <h3 className="text-2xl font-bold mb-3">Loslegen</h3>
        ...
        {/* Quizzes Placeholder */}
        <div>
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Deine Quizze</h3>
