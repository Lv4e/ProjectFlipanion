...
export interface SchemaEngine {
     ...
     */
    diagnoseMigrationHistory(input: EngineArgs.DiagnoseMigrationHistoryInput): Promise<EngineResults.DiagnoseMigrationHistoryOutput>;
    /**
     ...
     */
    introspect(input: EngineArgs.IntrospectParams & {
        viewsDirectoryPath: string;
    }): Promise<EngineArgs.IntrospectResult>;
    /**
