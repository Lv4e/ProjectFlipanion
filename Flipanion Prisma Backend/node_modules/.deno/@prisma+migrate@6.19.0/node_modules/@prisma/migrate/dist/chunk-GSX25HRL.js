...
var debugRpc = (0, import_debug.default)("prisma:schemaEngine:rpc");
var debugStderr = (0, import_debug.default)("prisma:schemaEngine:stderr");
var debugStdin = (0, import_debug.default)("prisma:schemaEngine:stdin");
...
var messageId = 1;
var SchemaEngineCLI = class _SchemaEngineCLI {
  debug;
  child;
  schemaContext;
  datasource;
...
${this.lastError?.backtrace ?? ""}`;
            exitWithErr(new import_internals.RustPanic(serializePanic(engineMessage), stackTrace, this.lastRequest, import_internals.ErrorArea.LIFT_CLI));
          };
          switch (code) {
        ...
        (0, import_chunk_L6KOIJJ5.byline)(this.child.stderr).on("data", (msg) => {
        ...
        (0, import_chunk_L6KOIJJ5.byline)(this.child.stdout).on("data", (line) => {
...
${response.error.data?.message ?? ""}`;
              reject(
                ...
                new import_internals.RustPanic(message, stackTrace, this.lastRequest, import_internals.ErrorArea.LIFT_CLI)
              );
            } else if (response.error.data?.message) {
              let message = `${(0, import_chunk_SKRR5WT4.red)((0, import_internals.relativizePathInPSLError)(response.error.data.message))}
`;
              if (response.error.data?.error_code) {
                message = (0, import_chunk_SKRR5WT4.red)(`${response.error.data.error_code}
...
`) + message;
              ...
              reject(
                new Error(
                  `${(0, import_chunk_SKRR5WT4.red)("Error in RPC")}
