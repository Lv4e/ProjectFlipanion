...
import { type MigrateTypes, SchemaContext } from '@prisma/internals';
...
export declare class SchemaEngineCLI implements SchemaEngine {
    private debug;
    private child?;
     ...
     */
    introspect({ schema, force, baseDirectoryPath, viewsDirectoryPath, compositeTypeDepth, // cannot be undefined
    namespaces, }: EngineArgs.IntrospectParams): Promise<EngineArgs.IntrospectResult>;
    /**
     ...
     */
    schemaPush(args: EngineArgs.SchemaPushInput): Promise<EngineResults.SchemaPush>;
    /**
     * SQL introspection that powers TypedSQL feature
     * @param args
     * @returns
     */
    introspectSql(args: EngineArgs.IntrospectSqlParams): Promise<EngineResults.IntrospectSqlOutput>;
    stop(): Promise<void>;
    private rejectAll;
