...
function now() {
  ...
  return `${now2.getUTCFullYear()}${prefixZero(now2.getUTCMonth() + 1)}${prefixZero(now2.getUTCDate())}${prefixZero(
    now2.getUTCHours()
  )}${prefixZero(now2.getUTCMinutes())}${prefixZero(now2.getUTCSeconds())}`;
}
