...
function omit(type, keyType) {
  return (0, import_ts_builders.namedType)("Omit").addGenericArgument(type).addGenericArgument(keyType);
}
...
${availableActions.includes(DMMF2.ModelAction.aggregate) ? `${(0, import_indent_string5.default)(getMethodJSDoc(DMMF2.ModelAction.count, mapping, modelOrType), TAB_SIZE)}
  ...
  >
` : ""}
${availableActions.includes(DMMF2.ModelAction.aggregate) ? `${(0, import_indent_string5.default)(getMethodJSDoc(DMMF2.ModelAction.aggregate, mapping, modelOrType), TAB_SIZE)}
...
` : ""}
${availableActions.includes(DMMF2.ModelAction.groupBy) ? `${(0, import_indent_string5.default)(getMethodJSDoc(DMMF2.ModelAction.groupBy, mapping, modelOrType), TAB_SIZE)}
  groupBy<
...
async function deleteOutputDir(outputDir) {
  try {
    ...
    await Promise.allSettled(
      ...
      )).map((file4) => import_promises.default.unlink(file4))
    );
  } catch (error) {
