...
var require_fs = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.3.0/node_modules/fs-extra/lib/fs/index.js"(exports2) {
    ...
    api.forEach((method3) => {
      exports2[method3] = u(fs3[method3]);
    });
...
var require_utils2 = __commonJS({
  "../../node_modules/.pnpm/jsonfile@6.1.0/node_modules/jsonfile/utils.js"(exports2, module2) {
    ...
    module2.exports = { stringify: stringify9, stripBom };
  }
});
...
function promise(resultType) {
  return new import_ts_builders.NamedType("$Utils.JsPromise").addGenericArgument(resultType);
}
...
function optional(innerType) {
  return new import_ts_builders.NamedType("$Utils.Optional").addGenericArgument(innerType);
}
...
`;
  ...
  getAggregationTypes() {
    ...
    aggregateType = (0, import_klona.klona)(aggregateType);
...
${availableActions.includes(DMMF2.ModelAction.aggregate) ? `${(0, import_indent_string3.default)(getMethodJSDoc(DMMF2.ModelAction.count, mapping, modelOrType), TAB_SIZE)}
  ...
  >
` : ""}
${availableActions.includes(DMMF2.ModelAction.aggregate) ? `${(0, import_indent_string3.default)(getMethodJSDoc(DMMF2.ModelAction.aggregate, mapping, modelOrType), TAB_SIZE)}
...
` : ""}
${availableActions.includes(DMMF2.ModelAction.groupBy) ? `${(0, import_indent_string3.default)(getMethodJSDoc(DMMF2.ModelAction.groupBy, mapping, modelOrType), TAB_SIZE)}
  groupBy<
...
function buildTypedQueryCjs({ query, runtimeBase, runtimeName }) {
  const writer = new import_ts_builders3.Writer(0, void 0);
  writer.writeLine('"use strict"');
