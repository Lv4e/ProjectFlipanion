...
export default function CreateQuiz() {
  ...
  const validate = (): string | null => {
    ...
    for (let i = 0; i < questions.length; i++) {
      const q = questions[i];
      if (!q.questionText.trim()) return `Frage ${i + 1}: Bitte gib den Fragetext ein.`;
      ...
      <div className="min-h-screen bg-[var(--background)]">
        ...
        <main className="max-w-2xl mx-auto px-6 pt-28 pb-12">
          <div className="glass-card rounded-2xl p-10 text-center animate-fade-in-up">
            ...
            <h2 className="text-xl font-bold text-[var(--foreground)] mb-2">Anmeldung erforderlich</h2>
            <p className="text-[var(--text-muted)] mb-6">Du musst angemeldet sein, um ein Quiz zu erstellen.</p>
            <Link href="/auth">
      ...
      <div className="min-h-screen bg-[var(--background)]">
        ...
        <main className="max-w-2xl mx-auto px-6 pt-28 pb-12">
          <div className="glass-card rounded-2xl p-10 text-center animate-fade-in-up">
            ...
            <h2 className="text-xl font-bold text-[var(--foreground)] mb-2">Quiz erstellt! 🎉</h2>
            <p className="text-[var(--text-muted)]">Du wirst gleich weitergeleitet ...</p>
          </div>
        </main>
        <Footer />
      </div>
          ...
          <div className="space-y-5">
            ...
            <div>
              <label htmlFor="description" className="block text-sm font-medium text-[var(--foreground)] mb-2">
                Beschreibung <span className="text-[var(--text-muted)] text-xs">(optional)</span>
              </label>
              <textarea
                id="description"
                      ...
                      <div key={num} className="relative">
                        ...
                        <div className="relative">
                          ...
                          <button
                            ...
                            title={isCorrect ? 'Richtige Antwort' : 'Als richtig markieren'}
